...
const Pastorder = () => {
  ...
  const gettingData = async () => {
    await fetch("https://laundry-cart-server-sides.herokuapp.com/getOrder", {
  ...
  const deleteOrder = () => {
    ...
    fetch("https://laundry-cart-server-sides.herokuapp.com/deleteOrder/" + orderId, {
      method: "DELETE",
      headers: {
        authtoken: token,
      },
  ...
  const changeHandler = (id) => {
    setVisible(!Visible);
    setorderId(id);
    fetch(`https://laundry-cart-server-sides.herokuapp.com/order/${id}`, {
      method: "GET",
      headers: {
        authtoken: token,
      },
